...
(
  ...
  USERCONSENT                 MIRTH_BOOLEAN NOT NULL,
...
ALTER TABLE DEBUGGER_USAGE ADD CONSTRAINT U_DUSE_ID UNIQUE (ID);

INSERT INTO PERSON (USERNAME, LOGGED_IN, USERCONSENT) VALUES('mirthhl7', 0, 0);

INSERT INTO PERSON_PASSWORD (PERSON_ID, PASSWORD) VALUES(1, 'BS0mJIEdbo6H516J64IByp9Yl1K8aAw1y04SYmHeRyzBT6Hnnr+9rw==');

INSERT INTO SCHEMA_INFO (VERSION) VALUES ('4.4.2');
